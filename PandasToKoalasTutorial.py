...
# MAGIC %md
# MAGIC # 10 minutes from pandas to Koalas
# MAGIC 
# MAGIC [pandas](https://pandas.pydata.org/) is a great tool to analyze small datasets on a single machine. When the need for bigger datasets arises, users often choose PySpark. However, the converting code from pandas to [PySpark](https://pandas.pydata.org/) is not easy as [PySpark APIs](https://pandas.pydata.org/) are considerably different from pandas APIs. Koalas makes the learning curve significantly easier by providing pandas-like APIs on the top of PySpark. With [Koalas](https://github.com/databricks/koalas), users can take advantage of the benefits of PySpark with minimal efforts, and thus get to value much faster. You can read more about this in this [blog](https://databricks.com/blog/2020/03/31/10-minutes-from-pandas-to-koalas-on-apache-spark.html) and [Koalas get-started documentation](https://koalas.readthedocs.io/en/latest/getting_started/index.html).

# COMMAND ----------

# MAGIC %md ## Setup
# MAGIC 
# MAGIC This requires a minimum of Databricks Runtime 7.6+, and the runtime comes preinstalled with PySpark, Koalas, pandas, and all the relevant libaries. No need to install anything.
# MAGIC Just run with it and learn!

# COMMAND ----------

# MAGIC %md
# MAGIC ## Migration from pandas to Koalas
...
# MAGIC %md
# MAGIC ### Applying Python function with Koalas object
...
kdf.plot.scatter(x='length',
                 y='width',
                 c='species')
   #              colormap='viridis') # got an error here about colormap

# COMMAND ----------

# MAGIC %md
# MAGIC ## Missing Functionalities and Workarounds in Koalas
